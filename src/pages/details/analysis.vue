<template>
  <div class="sales-board">
    ...
    <div class="sales-board-form">
      <div class="sales-board-line">
        ...
        <div class="sales-board-line-right">
          <VConter :key="key" @on-change="onParamChange('buyNum', $event)"></VConter>
        </div>
      </div>
      <div class="sales-board-line">
        <div class="sales-board-line-left">
      ...
      <div class="sales-board-line">
        ...
        <div class="sales-board-line-right">
          <VMultiplyChoose
            ...
            @on-change="onParamChange('versions', $event)"></VMultiplyChoose>
        </div>
      </div>
      <div class="sales-board-line">
        <div class="sales-board-line-left">
      ...
      <div class="sales-board-line">
        ...
        <div class="sales-board-line-right">
          <div class="button" @click="chooseBank">
            立即购买
          </div>
        </div>
      </div>
    ...
    <MyDialog :is-show="isShowBankDialog" @on-close="hideDialog('isShowBankDialog')">
      ...
      <BankChooser @on-change="chooseSelection"></BankChooser>
      <div class="button buy-dialog-btn">
      确认购买
      </div>
    </MyDialog>

    <!--<Dialogs :is-show="isShowPayDialog" >-->
      <!--<table class="buy-dialog-table">-->
        <!--<tr>-->
          <!--<th>购买数量</th>-->
          <!--<th>产品类型</th>-->
...
<script>
  ...
  import VConter from '../../components/counter'
